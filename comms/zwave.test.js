  ...
  describe('methodsAvailableToDriver', () => {
    ...
    describe('getAllNodes', () => {
      it('should expose the method', async () => {
        ...
        const zwaveComms = await zwaveCommsModule(interfaceObj, interfaceConfig);
        expect(typeof zwaveComms.methodsAvailableToDriver.getAllNodes).toEqual('function');
      });
    ...
    describe('getNodesClaimedByDriver', () => {
      it('should expose the method', async () => {
        ...
        const zwaveComms = await zwaveCommsModule(interfaceObj, interfaceConfig);
        expect(typeof zwaveComms.methodsAvailableToDriver.getNodesClaimedByDriver).toEqual('function');
      });
      ...
      it('should return a list of all the nodes claimed by the specified driver', async () => {
        ...
        const nodes = await zwaveComms.methodsAvailableToDriver.getNodesClaimedByDriver('driver1');
        expect(nodes).toMatchSnapshot();
      });
    });
    ...
    describe('getUnclaimedNodes', () => {
      it('should expose the method', async () => {
        ...
        const zwaveComms = await zwaveCommsModule(interfaceObj, interfaceConfig);
        expect(typeof zwaveComms.methodsAvailableToDriver.getUnclaimedNodes).toEqual('function');
      });
    ...
    describe('setValue', () => {
      it('should expose the method', async () => {
        ...
        const zwaveComms = await zwaveCommsModule(interfaceObj, interfaceConfig);
        expect(typeof zwaveComms.methodsAvailableToDriver.setValue).toEqual('function');
      });
      ...
      it('should call the setValue method on the zwave interface', async () => {
        ...
        await zwaveComms.methodsAvailableToDriver.setValue('nodeId', 'classId', 'instanceId', 'index', 'value');
        expect(setValue).toHaveBeenCalledTimes(1);
        expect(setValue).toHaveBeenCalledWith('nodeId', 'classId', 'instanceId', 'index', 'value');
      });
    });
    ...
    describe('setConfig', () => {
      it('should expose the method', async () => {
        ...
        const zwaveComms = await zwaveCommsModule(interfaceObj, interfaceConfig);
        expect(typeof zwaveComms.methodsAvailableToDriver.setConfig).toEqual('function');
      });
      ...
      it('should call the setValue method on the zwave interface', async () => {
        ...
        await zwaveComms.methodsAvailableToDriver.setConfig('nodeId', 'instanceId', 'index', 'value');
        expect(setConfig).toHaveBeenCalledTimes(1);
        expect(setConfig).toHaveBeenCalledWith('nodeId', 'instanceId', 'index', 'value');
      });
    });
    ...
    describe('claimNode', () => {
      it('should expose the method', async () => {
        ...
        const zwaveComms = await zwaveCommsModule(interfaceObj, interfaceConfig);
        expect(typeof zwaveComms.methodsAvailableToDriver.claimNode).toEqual('function');
      });
