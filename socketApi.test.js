...
describe('socketApi', () => {
  it('should return the instance of the socket', async () => {
    ...
    const drivers = {};
    const constants = {};
    const socketApi = socketApiModule.initialise(ioLib, authenticateCtrl, eventCtrl, driverCtrl, eventUtils, httpServer, drivers, constants);
  ...
  describe('Error handler', () => {
    it('should handle Driver errors', () => {
      ...
      expect(result).toEqual({
        code: 500, driver: 'DriverId', message: 'Error message', type: 'Driver',
      });
    });
    ...
    it('should handle BadRequest errors', () => {
      ...
      const result = socketApiModule.errorHandler(err);
      expect(result).toEqual({
        code: 400, message: 'Error message', type: 'BadRequest',
      });
    });
    ...
    it('should handle Validation errors', () => {
      ...
      const result = socketApiModule.errorHandler(err);
      expect(result).toEqual({
        code: 400, errors: [{ foo: 'bar' }], message: 'Error message', type: 'Validation',
      });
    });
    ...
    it('should handle Connection errors', () => {
      ...
      const result = socketApiModule.errorHandler(err);
      expect(result).toEqual({
        code: 503, message: 'Error message', type: 'Connection',
      });
    });
    ...
    it('should handle Authentication errors', () => {
      ...
      const result = socketApiModule.errorHandler(err);
      expect(result).toEqual({
        code: 401, message: 'Error message', type: 'Authentication',
      });
    });
  ...
  describe('Event emitter', () => {
    it('should subcribe to driver events and emit them on the socket', async () => {
      ...
      socketApiModule.initialise(ioLib, authenticateCtrl, eventCtrl, driverCtrl, eventUtils, httpServer, drivers, constants);
      expect(eventUtils.eventEmitter.on).toHaveBeenCalledTimes(1);
      expect(eventUtils.eventEmitter.on.mock.calls[0][0]).toEqual('DEVICE_EVENT');
  ...
  describe('Endpoints', () => {
    describe('getAuthenticationProcess', () => {
      ...
      it('should catch any errors and return them', async () => {
        ...
        const authenticateCtrl = {
          getAuthenticationProcess: jest.fn().mockReturnValue(Promise.reject(err)),
        };
        const eventCtrl = {};
        const driverCtrl = {};
        const eventUtils = {
        ...
        expect(cb).toHaveBeenCalledWith({
          code: 500, driver: 'Driver id', message: 'the error', type: 'Driver',
        });
      });
    });
    ...
    describe('getCommandDescriptions', () => {
      it('should call driverCtrl.getCommandDescriptions and return the result', async () => {
        const socket = {
          on: jest.fn(),
        };
        const io = {
        ...
        const ioCallback = io.on.mock.calls[0][1];
        ioCallback(socket);
        expect(socket.on.mock.calls[11][0]).toEqual('getCommandDescriptions');
      ...
      it('should catch any errors and return them', async () => {
        ...
        err.driver = 'Driver id';
        const driverCtrl = {
          getCommandDescriptions: jest.fn().mockReturnValue(Promise.reject(err)),
        };
        const eventCtrl = {};
        const authenticateCtrl = {};
        const eventUtils = {
    ...
    describe('getDeviceTypes', () => {
      it('should call driverCtrl.getDeviceTypes and return the result', async () => {
        ...
        const ioLib = jest.fn().mockReturnValue(io);
        const driverCtrl = {
          getDeviceTypes: jest.fn().mockReturnValue(Promise.resolve({ foo: 'bar' })),
        };
        const eventCtrl = {};
        const authenticateCtrl = {};
        const eventUtils = {
